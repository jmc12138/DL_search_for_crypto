...
@register('BLSTM_speck2')
class Net2(nn.Module):
    def __init__(self,dropout,hidden_size,num_layers):
        self.hidden_size = hidden_size
        super(Net2, self).__init__()
        self.lstm = nn.LSTM(input_size=32, hidden_size=self.hidden_size, num_layers=num_layers,bidirectional=True,batch_first=True)
